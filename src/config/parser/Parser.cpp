...
namespace config {
	...
	void Parser::parseListen(const std::vector<std::string>& tokens, Config& config,
							 unsigned long& i) {
		char* end = NULL;
	...
	void Parser::parseIndex(const std::vector<std::string>& tokens, Config& config,
							unsigned long& i) {
		config.setIndex(tokens.at(i));
		expectToken(tokens, ++i, ";");
	}

	void Parser::parseRoot(const std::vector<std::string>& tokens, Config& config,
						   unsigned long& i) {
